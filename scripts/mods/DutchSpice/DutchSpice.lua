...
--UI fluff
mod:hook(IngamePlayerListUI, "update_difficulty", function (func, self)
	...
	local difficulty_name = deathwish_enabled and "deathwish_dutchspice" or base_difficulty_name .. "_dutchspice"

	if difficulty_name ~= self.current_difficulty_name then
		self:set_difficulty_name(deathwish_enabled and "Deathwish Dutch Spice" or Localize(base_difficulty_name) .. " Dutch Spice")
...
PatrolFormationSettings.beastmen_standard = {
	...
	TerrorEventBlueprints.fort.fort_horde_gate = {
		...
		},
		{
			...
			duration = 50,
			condition = function (t)
				return count_event_breed("chaos_marauder") < 16 and count_event_breed("chaos_berzerker") < 8 and count_event_breed("chaos_warrior") < 6
			end
		},
		{
			"flow_event",
	...
	TerrorEventBlueprints.skaven_stronghold.stronghold_horde_water_wheels = {
		...
		},
		{
			"continue_when",
			condition = function (t)
				return count_event_breed("skaven_slave") < 12 and count_event_breed("skaven_clan_rat_with_shield") < 8 and count_event_breed("skaven_storm_vermin_with_shield") < 4 and count_event_breed("skaven_storm_vermin") < 10
			end
		},
		{
			"flow_event",
	...
	TerrorEventBlueprints.ussingen.ussingen_payload_event_01 = {
		...
		},
		{
			...
			duration = 70,
			condition = function (t)
				return count_event_breed("chaos_berzerker") < 12 and count_event_breed("chaos_raider") < 10 and (count_event_breed("chaos_marauder") + count_event_breed("chaos_marauder_with_shield")) < 24 and count_event_breed("chaos_fanatic") < 26 and count_event_breed("chaos_warrior") < 7
			end
		},
		{
			"delay",
	...
	TerrorEventBlueprints.dlc_bogenhafen_slum.dlc_bogenhafen_slum_event_end_loop = {
		...
		},
		{
			...
			duration = 40,
			condition = function (t)
				return (count_event_breed("chaos_marauder_with_shield") + count_event_breed("chaos_marauder")) < 26
			end
		},
		{
			"continue_when",
			duration = 60,
			condition = function (t)
				return (count_event_breed("skaven_clan_rat") + count_event_breed("skaven_clan_rat_with_shield")) < 30 and count_event_breed("skaven_slave") < 12 and count_event_breed("skaven_storm_vermin_commander") < 10
			end
		},
		{
			"delay",
	...
	TerrorEventBlueprints.dlc_bogenhafen_city.dlc_bogenhafen_city_temple_loop = {
		...
		},
		{
			...
			duration = 15,
			condition = function (t)
				return count_event_breed("skaven_clan_rat") < 30 and count_event_breed("skaven_slave") < 32 and count_event_breed("skaven_storm_vermin_commander") < 12 and count_event_breed("chaos_fanatic") < 24 and count_event_breed("chaos_marauder") < 16 and count_event_breed("skaven_gutter_runner") < 6 and count_event_breed("skaven_pack_master") < 6 and (count_event_breed("skaven_poison_wind_globadier") + count_event_breed("skaven_warpfire_thrower") + count_event_breed("skaven_ratling_gunner")) < 8
			end
		},
		{
			"delay",
	...
	TerrorEventBlueprints.magnus.magnus_door_a = {
		...
		},
		{
			...
			duration = 7,
			condition = function (t)
				return (count_breed("chaos_marauder") + count_breed("chaos_marauder_with_shield")) < 14 and count_breed("chaos_fanatic") < 20 and count_breed("chaos_raider") < 8 and count_breed("chaos_berzerker") < 8
			end
		},
		{
			"continue_when",
		...
		},
		{
			...
			duration = 12,
			condition = function (t)
				return (count_breed("skaven_clan_rat") + count_breed("skaven_clan_rat_with_shield")) < 20 and count_breed("skaven_slave") < 25 and (count_breed("skaven_storm_vermin_commander") + count_breed("skaven_storm_vermin_with_shield")) < 8 and count_breed("skaven_plague_monk") < 8
			end
		},
		{
			"continue_when",
		...
		},
		{
			...
			duration = 7,
			condition = function (t)
				return (count_breed("skaven_clan_rat") + count_breed("skaven_clan_rat_with_shield")) < 18 and count_breed("skaven_slave") < 25 and (count_breed("skaven_storm_vermin_commander") + count_breed("skaven_storm_vermin_with_shield")) < 8 and count_breed("skaven_plague_monk") < 8
			end
		},
		{
			"continue_when",
	...
	TerrorEventBlueprints.magnus.magnus_door_b = {
		...
		},
		{
			"event_horde",
			spawner_id = "magnus_door_event_chaos",
			composition_type = "event_medium_chaos_chaos"
		},
		{
			"event_horde",
			spawner_id = "magnus_door_event_chaos",
		...
		},
		{
			...
			duration = 12,
			condition = function (t)
				return (count_breed("chaos_marauder") + count_breed("chaos_marauder_with_shield")) < 16 and count_breed("chaos_fanatic") < 20 and count_breed("chaos_raider") < 8 and count_breed("chaos_berzerker") < 8
			end
		},
		{
			"continue_when",
	...
	TerrorEventBlueprints.magnus.magnus_end_event = {
		...
		},
		{
			...
			duration = 45,
			condition = function (t)
				return (count_event_breed("skaven_clan_rat") + count_event_breed("skaven_clan_rat_with_shield")) < 26 and count_event_breed("skaven_slave") < 35 and count_event_breed("skaven_storm_vermin_commander") < 9 and count_event_breed("skaven_plague_monk") < 9
			end
		},
		{
			"flow_event",
		...
		},
		{
			...
			duration = 45,
			condition = function (t)
				return (count_event_breed("skaven_clan_rat") + count_event_breed("skaven_clan_rat_with_shield")) < 24 and count_event_breed("skaven_slave") < 35 and count_event_breed("skaven_storm_vermin_commander") < 9 and count_event_breed("skaven_plague_monk") < 9
			end
		},
		{
			"play_stinger",
		...
		},
		{
			...
			duration = 45,
			condition = function (t)
				return (count_event_breed("chaos_marauder") + count_event_breed("chaos_marauder_with_shield")) < 20 and count_event_breed("chaos_fanatic") < 28 and count_event_breed("chaos_raider") < 9 and count_event_breed("chaos_berzerker") < 9 and count_event_breed("chaos_warrior") < 5
			end
		},
		{
			"delay",
		...
		},
		{
			...
			duration = 45,
			condition = function (t)
				return (count_event_breed("skaven_clan_rat") + count_event_breed("skaven_clan_rat_with_shield")) < 28 and count_event_breed("skaven_slave") < 35 and count_event_breed("skaven_storm_vermin_commander") < 9 and count_event_breed("skaven_plague_monk") < 9
			end
		},
		{
			"control_specials",
		...
		},
		{
			...
			duration = 45,
			condition = function (t)
				return (count_event_breed("chaos_marauder") + count_event_breed("chaos_marauder_with_shield")) < 20 and count_event_breed("chaos_fanatic") < 30 and count_event_breed("chaos_raider") < 9 and count_event_breed("chaos_berzerker") < 9 and count_event_breed("chaos_warrior") < 5
			end
		},
		{
			"spawn_special",
