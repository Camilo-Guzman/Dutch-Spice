...
BreedTweaks.max_health.chaos_bulwark = health_steps(46, elite_health_step_multipliers)
...
local item_categories = {
	...
	marauder_sword_one_handed_right = {
...
NewInventoryConfigurations.sword_marauder = {
    enemy_hit_sound = "sword",
    anim_state_event = "to_sword",
    items = {
        item_categories.marauder_sword_one_handed_right
    }
}
...
--Axe Shield Marauder
Breeds.skaven_clan_rat_tutorial = table.create_copy(Breeds.skaven_clan_rat_tutorial, Breeds.chaos_marauder_with_shield)
BreedActions.skaven_clan_rat_tutorial = {}
BreedActions.skaven_clan_rat_tutorial = table.create_copy(BreedActions.skaven_clan_rat_tutorial, BreedActions.chaos_marauder_with_shield)
Breeds.skaven_clan_rat_tutorial.name = "skaven_dummy_clan_rat"
Breeds.skaven_clan_rat_tutorial.default_inventory_template = "marauder_axe_shield"
Breeds.skaven_clan_rat_tutorial.behavior = "shield_marauder"
Breeds.skaven_clan_rat_tutorial.horde_behavior = "shield_marauder"
Breeds.skaven_clan_rat_tutorial.poison_resistance = 100
Breeds.skaven_clan_rat_tutorial.armor_category = 2
Breeds.skaven_clan_rat_tutorial.unbreakable_shield = true
Breeds.skaven_clan_rat_tutorial.max_health = BreedTweaks.max_health.ratling_gunner
Breeds.skaven_clan_rat_tutorial.unit_template = "ai_unit_shield_marauder"

--Armoured sword marauder
Breeds.skaven_dummy_clan_rat = table.create_copy(Breeds.skaven_dummy_clan_rat, Breeds.chaos_marauder)
BreedActions.skaven_dummy_clan_rat = {}
BreedActions.skaven_dummy_clan_rat = table.create_copy(BreedActions.skaven_dummy_clan_rat, BreedActions.chaos_marauder)
Breeds.skaven_dummy_clan_rat.name = "skaven_dummy_clan_rat"
Breeds.skaven_dummy_clan_rat.default_inventory_template = "sword_marauder"
Breeds.skaven_dummy_clan_rat.poison_resistance = 100
Breeds.skaven_dummy_clan_rat.armor_category = 2
Breeds.skaven_dummy_clan_rat.hitzone_armor_categories = { head = 1 }
Breeds.skaven_dummy_clan_rat.hitzone_primary_armor_categories = { head = { attack = 1, impact = 2 } }
...
EnemyPackageLoaderSettings.max_loaded_breed_cap = 45